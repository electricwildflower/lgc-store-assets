...
# App metadata
# --------------------------
APP_NAME="Spotify"                   # Name stored in apps.json
FOLDER_NAME="spotify"                # Folder name under /apps/
DISPLAY_NAME="Spotify"  # Pretty name
PACKAGE_NAME="spotify"               # apt/flatpak/snap ID
